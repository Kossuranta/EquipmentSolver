...
- Create Angular project with ng: `ng new equipmentsolver.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`equipmentsolver.client.esproj`).
